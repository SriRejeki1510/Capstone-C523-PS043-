              ...
              <div class="col-lg-6">
                <div class="card mb-3 musik custom-height-card">
                  <div class="card-body">
                    ...
                    <a href="../capstone/music_podcast/index-music-user.php">
              ...
              <div class="col-lg-6">
                <div class="card mb-3 podcast">
                  <div class="card-body">
                    ...
                    <a href="../capstone/music_podcast/index-podcast-user.php">
              ...
              <div class="col-lg-6 offset-lg-6">
                <div class="card custom-card2">
                  <div class="card-body">
                    ...
                    <a href="../capstone/Tampilan_video/index-video-user.php">
