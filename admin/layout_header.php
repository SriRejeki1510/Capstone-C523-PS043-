        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="rekap.php" class="waves-effect <?php if($title=='rekap'){echo 'active';}?>"><i class="fa fa-file-text fa-fw" aria-hidden="true"></i> Rekap user</a>
                    </li>
                    <li>
                        <a href="chart.php" class="waves-effect <?php if($title=='chart'){echo 'active';}?>"><i class="fa fa-tachometer fa-fw" aria-hidden="true"></i> chart</a>
                    </li>
                </ul>
