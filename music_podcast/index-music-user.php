    ...
    <div class="container-md">
      ...
      <div class="main">
        <div class="audio audio1 dark">
            <a href="music3-user.php"><img src="images/page-music/hindia.png" alt=""></a>
            <h2>Hindia</h2>
            <p>Deretan musik hindia terpopuler saat ini.</p>
        </div>
        <div class="audio audio1 dark">
          <a href="music1-user.php"><img src="images/page-music/music-1.jpg" alt=""></a>
            <h2>CAS Till i sleep</h2>
            <p>Deretan musik CAS terpopuler</p>
        </div>
        <div class="audio audio1 dark">
          <a href="music2-user.php"><img src="images/page-music/music-2.jpg" alt=""></a>
            <h2>Indie</h2>
            <p>Dengarkan musik indie yang tersedia.</p>
        </div>
        <div class="audio audio1 dark">
          <a href="music4-user.php"><img src="images/page-music/music-4.jpeg" alt=""></a>
            <h2>ColdPlay</h2>
            <p>Deretan Lagu Coldplay Terpopuler saat ini.</p>
        </div>
        <div class="audio audio1 dark">
          <a href="music5-user.php"><img src="images/page-music/music-5.jpg" alt=""></a>
            <h2>Payung Teduh</h2>
