...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="home-login.php">DreamSync</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="navbar-brand getstarted scrollto" style="margin-left:100px;"><img src="./capstone2/assets/img/user.png"
                alt="user"><?php echo $_SESSION['first_name']; ?></a></li>
              ...
              <div class="col-lg-6">
                <div class="card mb-3 musik custom-height-card">
                  <div class="card-body">
                    ...
                    <a href="../capstone-fix/music_podcast/index-music-user.php">
              ...
              <div class="col-lg-6">
                <div class="card mb-3 podcast">
                  <div class="card-body">
                    ...
                    <a href="../capstone-fix/music_podcast/index-podcast-user.php">
              ...
              <div class="col-lg-6 offset-lg-6">
                <div class="card custom-card2">
                  <div class="card-body">
                    ...
                    <a href="../capstone-fix/Tampilan_Video/index-video-user.php">
