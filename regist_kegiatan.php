...
$redirect_uri = 'https://21102117.kelasmm3.cloud/21102117-mm3-pw2324/capstone-fix/regist_kegiatan.php';
        ...
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            ...
            <div class="col-md-6 right-box">
                <div class="row align-items-center">
                    ...
                    <form action="tambahuser_kegiatan.php" method="post" onsubmit="return validateForm()">
                    <div class="row">
                        <div class="col-md-6">
